...
(
 ...
 ['e5','-k1,1%', {EXIT=>2},
  {ERR=>"$prog: invalid key specification: invalid field specification '1,1%'\n"}],
 ['e6','-k1,1:', {EXIT=>2},
  {ERR=>"$prog: missing internal conversion function: invalid field specification '1,1:'\n"}],
 ['e7','-k1,1@', {EXIT=>2},
  {ERR=>"$prog: missing external conversion command: invalid field specification '1,1\@'\n"}],
 ['e8','-k1,1@foobar', {EXIT=>2},
  {ERR=>"$prog: external commands are not implemented (yet)\n"}],
 ['e9','-k1,1:foobar', {EXIT=>2},
  {ERR=>"$prog: invalid built-in conversion option: invalid field specification '1,1:foobar'\n"}],
 ...
 ['e20','-k1b,1:foobar', {EXIT=>2},
  {ERR=>"$prog: ordering flags (b/d/i/h/n/g/M/R/V) can not be combined with a conversion function: invalid field specification '1b,1:foobar'\n"}],
 ['e21','-k1,1b:foobar', {EXIT=>2},
  {ERR=>"$prog: ordering flags (b/d/i/h/n/g/M/R/V) can not be combined with a conversion function: invalid field specification '1,1b:foobar'\n"}],
 ['e22','-k1f,1:foobar', {EXIT=>2},
  {ERR=>"$prog: ordering flags (b/d/i/h/n/g/M/R/V) can not be combined with a conversion function: invalid field specification '1f,1:foobar'\n"}],
 ['e23','-k1d,1:foobar', {EXIT=>2},
  {ERR=>"$prog: ordering flags (b/d/i/h/n/g/M/R/V) can not be combined with a conversion function: invalid field specification '1d,1:foobar'\n"}],
 ['e24','-k1n,1:foobar', {EXIT=>2},
  {ERR=>"$prog: ordering flags (b/d/i/h/n/g/M/R/V) can not be combined with a conversion function: invalid field specification '1n,1:foobar'\n"}],
 ['e25','-k1g,1:foobar', {EXIT=>2},
  {ERR=>"$prog: ordering flags (b/d/i/h/n/g/M/R/V) can not be combined with a conversion function: invalid field specification '1g,1:foobar'\n"}],
 ['e26','-k1M,1:foobar', {EXIT=>2},
  {ERR=>"$prog: ordering flags (b/d/i/h/n/g/M/R/V) can not be combined with a conversion function: invalid field specification '1M,1:foobar'\n"}],
