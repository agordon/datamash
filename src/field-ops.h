...
struct fieldop
{
  ...
  bool primary;     /* if true, this field_op uses another as a subordinate */
  bool subordinate;      /* if true, not used directly, but referenced by
                      another field_op */
  size_t subordinate_idx;
  struct fieldop* subordinate_op;
